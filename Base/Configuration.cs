...
namespace Spectrum.Base {
   ...
   *
   * This abstract surface carries persisted settings only. Live runtime state
   * and services live with their owners and are exposed by the Operator: the
  ...
  public abstract class Configuration :
      ConfigurationScalars, INotifyPropertyChanged {
    ...
    public abstract ImmutableArray<DomeLayerView> domeLayerStack { get; }
    ...
    public abstract ImmutableArray<int> domeCableMapping { get; }
    ...
    // identity per box.
    public abstract ImmutableArray<ImmutableArray<int>> domePortMappings {
      get;
    }
    ...
    public abstract ImmutableDictionary<string, int> domeLayerFireCounters {
      get;
    }
    ...
    public abstract ImmutableDictionary<string, int> domeLayerClearCounters {
      get;
    }
    ...
    public abstract ImmutableArray<DomeSceneView> domeScenes { get; }
    ...
    public abstract ImmutableArray<DomePaletteSnapshot> domePalettes { get; }

    public abstract ImmutableDictionary<int, int> midiDevices { get; }
    public abstract ImmutableDictionary<int, MidiPresetView> midiPresets {
      get;
    }
  }
