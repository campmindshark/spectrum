  ...
  public static class TelemetryCatalog {
    ...
    public static IReadOnlyList<TelemetryItem> Items { get; } =
      new List<TelemetryItem> {
        ...
        new TelemetryItem("visualizerFault", TelemetrySource.Runtime,
          nameof(RuntimeTelemetry.VisualizerFault),
          (t, b) => t?.VisualizerFault),
        new TelemetryItem("inputFault", TelemetrySource.Runtime,
          nameof(RuntimeTelemetry.InputFault),
          (t, b) => t?.InputFault),
        new TelemetryItem("outputFault", TelemetrySource.Runtime,
          nameof(RuntimeTelemetry.OutputFault),
          (t, b) => t?.OutputFault),
