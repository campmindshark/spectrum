...
namespace Spectrum {
  ...
  public partial class MainWindow : Window {
    ...
    private void LoadConfig() {
      ...
      this.Bind("domeActiveVis", this.domeActiveVisualizer, ComboBox.SelectedItemProperty, BindingMode.TwoWay, new SpecificValuesConverter<int, ComboBoxItem>(new Dictionary<int, ComboBoxItem> { [0] = this.domeActiveVisualizerVolume }));
